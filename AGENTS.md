...
Read `docs/CLAUDE_BUILD.md` before writing code — it carries the absolute
rules (greenfield-only, no founder backdoors, Motoko conventions) and phase
status. `docs/TRUST.md` is the authority on identities and powers.
